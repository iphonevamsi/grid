import { format, detectDataType, splitDecimals, changeDecimals, getEditorType, getMinMax, sanitizeSheetName, escapeRegExp, FORMAT_DEFAULT_DECIMAL, cellsInSelectionVariant } from './constants'
...
describe('cellsInSelectionVariant', () => {
  it('can generate styles for cells', () => {
    ...
    const cells = cellsInSelectionVariant(sel, 'all', 'thick', 'black', boundGetter)
